...
//
// Dieses Modul definiert die grundlegenden Typen fuer den KV-Cache:
// - Causal Struct (Hauptstruktur)
// - cacheCell (Zellenmetadaten)
// - cellRange (Bereichsverwaltung)
// - CausalOptions (Konfigurationsoptionen)
package kvcache
