...
// types.go - Tokenizer Typen, Konstanten und API-Methoden
//
// Enthält:
// - TokenizerType Enum (BPE, SentencePiece, WordPiece)
// - Vocabulary und Tokenizer Structs
// - GPT-2 byteToRune Encoding-Tabelle
// - API-Methoden: VocabSize, BOS, EOS, PAD, IsEOS, GetSpecialToken
