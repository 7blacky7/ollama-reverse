// Package kvcache - Sequenz-Operationen (Legacy/Kommentiert)
//
// Dieses Modul enthaelt die auskommentierten Sequenz-Verwaltungsfunktionen
// mit zusaetzlichem Debug-Logging fuer die shift-Operation.
// Unterschied zur Produktionsversion: Verwendet NewContext() statt
// NewContextSize(2) und hat alternative Tensor-Dimensionszugriffe.
package kvcache
