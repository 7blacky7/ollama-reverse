// Package ml stellt Backend-Abstraktion und Registrierung bereit.
// Dieses Modul enthält die Backend-Interfaces und Factory-Funktionen
// für das Laden von ML-Modellen.
package ml
